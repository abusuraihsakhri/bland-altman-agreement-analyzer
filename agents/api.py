"""
FastAPI REST API Server for Bland Altman Agreement Analyzer.
"""
...
app = FastAPI(
    title="Bland Altman Agreement Analyzer API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "bland-altman-agreement-analyzer", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
